  ...
  return (
    <div className='bg-white dark:bg-slate-900 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-slate-200/50 dark:border-slate-700/50'>
      <div className="mb-4 sm:mb-6">
        <h3 className='text-base sm:text-lg font-bold text-slate-800 dark:text-white'>Sales by Category</h3>
        <p className='text-xs sm:text-sm text-slate-500 dark:text-slate-400'>Product Distribution</p>
      </div>
